...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("memorymatch", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("memorymatch", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "memorymatch";
		app.meta["name"] = "memorymatch";
