...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_mm_1_mp3 extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_sounds_mm_1_wav extends null { }
...
@:keep @:file("assets/sounds/mm_1.mp3") @:noCompletion #if display private #end class __ASSET__assets_sounds_mm_1_mp3 extends haxe.io.Bytes {}
@:keep @:file("assets/sounds/mm_1.wav") @:noCompletion #if display private #end class __ASSET__assets_sounds_mm_1_wav extends haxe.io.Bytes {}
