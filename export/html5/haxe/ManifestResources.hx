...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_data_mm_1_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_images_go_here_txt extends null { }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_index_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:file("assets/data/mm_1.txt") @:noCompletion #if display private #end class __ASSET__assets_data_mm_1_txt extends haxe.io.Bytes {}
@:keep @:file("assets/images/images-go-here.txt") @:noCompletion #if display private #end class __ASSET__assets_images_images_go_here_txt extends haxe.io.Bytes {}
@:keep @:image("assets/images/index.png") @:noCompletion #if display private #end class __ASSET__assets_images_index_png extends lime.graphics.Image {}
